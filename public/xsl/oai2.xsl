...
>
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>GDZ - OAI 2.0 Request Results</title>
                <style>
                    <xsl:call-template name="style"/>
                </style>
            </head>
            <body>
                <h1>gdz.sub.uni-goettingen.de</h1>
                <h2>OAI 2.0 Request Results</h2>
                <xsl:call-template name="quicklinks"/>
                <p class="intro">You are viewing an HTML version of the XML OAI response. To see the underlying XML use
                    your web browsers view source option. More information about this XSLT is at the <a
                            href="#moreinfo">bottom of the page</a>.
                </p>
                ...
                <p>An XSLT file has converted the <a href="http://www.openarchives.org">OAI-PMH 2.0</a> responses into
                    XHTML which looks nice in a browser which supports XSLT such as Mozilla, Firebird and Internet
                    Explorer. The XSLT file was created by <a href="http://www.ecs.soton.ac.uk/people/cjg">Christopher
                        Gutteridge
                    </a> at the University of Southampton as part of the <a href="http://software.eprints.org">GNU
                        EPrints system</a>, and is freely redistributable under the <a href="http://www.gnu.org">GPL</a>.
                </p>
                <p>If you want to use the XSL file on your own OAI interface you may but due to the way XSLT works you
                    must install the XSL file on the same server as the OAI script, you can't just link to this copy.
                </p>
                <p>For more information or to download the XSL file please see the <a
                        href="http://software.eprints.org/xslt.php">OAI to XHTML XSLT homepage</a>.
                </p>
    ...
    <xsl:template name="quicklinks">
        <ul class="quicklinks">
            ...
            <li>
                <a href="?verb=ListRecords&amp;metadataPrefix=oai_dc">ListRecords (oai_dc)</a>
                |
            </li>
            <li>
                <a href="?verb=ListRecords&amp;metadataPrefix=mets">ListRecords (mets)</a>
                |
            </li>
            <li>
                <a href="?verb=ListIdentifiers&amp;metadataPrefix=oai_dc">ListIdentifiers (oai_dc)</a>
                |
            </li>
            <li>
                <a href="?verb=ListIdentifiers&amp;metadataPrefix=mets">ListIdentifiers (mets)</a>
                |
            </li>
            <li>
                <a href="?verb=ListRecords&amp;metadataPrefix=epicur">ListRecords (epicur)</a>
                |
            </li>
            <li>
    ...
    <xsl:template match="/oai:OAI-PMH">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <p>Request was of type <xsl:value-of select="oai:request/@verb"/>.
                </p>
                <div class="results">
    ...
    <xsl:template match="oai:record">
        <h2 class="oaiRecordTitle">OAI Record:
        ...
        <table class="values">
            <tr>
                ...
                <td class="value">
                    ...
                    <xsl:text> </xsl:text>
                    <a class="link" href="?verb=GetRecord&amp;metadataPrefix=oai_dc&amp;identifier={oai:identifier}">
                        oai_dc
                    </a>
                    <xsl:text> </xsl:text>
                    <a class="link" href="?verb=GetRecord&amp;metadataPrefix=mets&amp;identifier={oai:identifier}">
                        mets
                    </a>
                    <xsl:text> </xsl:text>
                    <a class="link"
                       href="https://dfg-viewer.de/show/?tx_dlf[id]=https://gdz.sub.uni-goettingen.de/mets/{substring(oai:identifier,31)}.mets.xml">
                        DFG-Viewer
                    </a>
                    <xsl:text> </xsl:text>
        ...
        <table class="values">
            <tr>
                ...
                <td class="value">
                    ...
                    <xsl:value-of select="@completeListSize"/> / Cursor: <xsl:value-of select="@cursor"/>)
                    <xsl:text> </xsl:text>
